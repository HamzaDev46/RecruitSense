...
const Sidebar = () => {
  ...
  useEffect(() => {
    const loadProfilePhoto = () => {
      api.get('/profile')
        .then((res) => setProfilePhoto(res.data.profile?.profile_image_url || ''))
    ...
    window.addEventListener('recruitsense-profile-updated', loadProfilePhoto)
    ...
    return () => {
      window.removeEventListener('recruitsense-profile-updated', loadProfilePhoto)
